...
export default function MessagerieAthlete({ params }: { params: { id: string } }) {
  ...
  function envoyer() {
    ...
    setMessages([...messages, { id: String(Date.now()), de: "coach", athleteId: params.id, texte: texte.trim(), quand: "à l'instant", lu: true }]);
    setTexte("");
  }

  return (
    <div className="bg-carte border border-bordure rounded-xl overflow-hidden flex flex-col h-[calc(100vh-18rem)]">
